...
public class Parser {
	...
	public Parser(String language, ObservableMap<String, Double> var,
			ObservableMap<String, String> functions2,
			List<ObjectProperty> bind, ObservableList<Color> color) {
		variables = var;
	...
	/**
	 * Replaces value from the previously executed command in the tree and
	 * retrieves the next command to be executed.
	 * 
	...
	/**
	 * Traverses the tree and retrieves the node that is the parent of the most
	 * nested command in order to replace that with the value of the most nested
	 * command executed.
	 * 
	 * @return Node
	 */
	...
	/**
	 * Creates tree out of Nodes using regex. Constants and variables are leaf
	 * children of commands. If a list is detected, creates anothr tree for the
